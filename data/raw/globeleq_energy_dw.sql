/*
Globeleq Energy Portfolio Data Warehouse
...
1. Static plant, technology, geography, organisation and agreement data is sourced from the
   uploaded Globeleq brochure snapshot.
...
*/
IF DB_ID(N'GlobeleqEnergyDW') IS NULL
BEGIN
    CREATE DATABASE GlobeleqEnergyDW;
END;
GO
...
INSERT INTO dw.DimOrganisation (OrganisationKey, OrganisationName, OrganisationType) VALUES (1, N'Globeleq', N'Developer / Owner / Operator');
...
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (1,N'ARC',N'ARC Solar Power',3,N'Aswan',NULL,N'Operating',N'Solar PV',66,N'MWp',NULL,NULL,NULL,NULL,N'Remote monitoring from Cape Town; asset management and O&M oversight.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (2,N'ARIES',N'Aries Solar Power',5,N'Kenhardt',N'Northern Cape',N'Operating',N'Solar PV',11,N'MWp',NULL,21.0,6300,NULL,N'Globeleq is majority shareholder and responsible for asset management.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (3,N'AZITO',N'Azito Power',7,N'Abidjan',NULL,N'Operating',N'Natural Gas',713,N'MW',NULL,NULL,NULL,NULL,N'Natural gas supplied from offshore gas fields; Globeleq majority owner.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (4,N'BOSHOF',N'Boshof Solar Power',5,N'Boshof',N'Free State',N'Operating',N'Solar PV',66,N'MWp',NULL,130.0,38900,NULL,N'Asset management, operations and maintenance.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (5,N'CUAMBA',N'Cuamba Solar PV + BESS',4,N'Cuamba',NULL,N'Operating',N'Solar PV + BESS',19,N'MWp',7.0,NULL,21800,172000.0,N'First IPP in Mozambique to integrate utility-scale storage.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (6,N'DEAAR',N'De Aar Solar Power',5,N'De Aar',N'Northern Cape',N'Operating',N'Solar PV',50,N'MWp',NULL,93.0,28000,NULL,N'Asset management, operations and maintenance.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (7,N'DIBAMBA',N'Dibamba Power',6,N'Douala',NULL,N'Operating',N'Heavy Fuel Oil',88,N'MW',NULL,NULL,NULL,NULL,N'Government of Cameroon holds remaining shares.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (8,N'DROOG',N'Droogfontein Solar Power',5,N'Kimberley',N'Northern Cape',N'Operating',N'Solar PV',50,N'MWp',NULL,90.0,27000,NULL,N'Asset management and maintenance.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (9,N'JBAY',N'Jeffreys Bay Wind Farm',5,N'Jeffreys Bay',N'Eastern Cape',N'Operating',N'Wind',138,N'MW',NULL,448.0,114100,NULL,N'60 turbines at 2.3 MW each.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (10,N'KLIP',N'Klipheuwel Wind Farm',5,N'Caledon',N'Western Cape',N'Operating',N'Wind',27,N'MW',NULL,86.0,25600,NULL,N'9 turbines at 3 MW each.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (11,N'KONK',N'Konkoonsies Solar Power',5,N'Pofadder',N'Northern Cape',N'Operating',N'Solar PV',11,N'MWp',NULL,21.0,6300,NULL,N'Asset management.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (12,N'KRIBI',N'Kribi Power',6,N'Kribi',NULL,N'Operating',N'Natural Gas',216,N'MW',NULL,NULL,NULL,NULL,N'Natural gas from the offshore Sanaga South gas field.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (13,N'MALINDI',N'Malindi Solar Power',1,N'Malindi',NULL,N'Operating',N'Solar PV',52,N'MWp',NULL,NULL,NULL,NULL,N'Utility-scale solar plant in Kenya''s coastal area.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (14,N'MOCUBA',N'Mocuba Solar',4,N'Mocuba',N'Zambezia',N'Operating',N'Solar PV',41,N'MWp',NULL,NULL,NULL,NULL,N'Construction completed in August 2019.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (15,N'SONGAS',N'Songas',2,N'Dar es Salaam',NULL,N'Operating',N'Natural Gas',190,N'MW',NULL,NULL,NULL,NULL,N'Includes gas processing and a 225 km pipeline.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (16,N'SOUTPAN',N'Soutpan Solar Power',5,N'Vivo',N'Limpopo',N'Operating',N'Solar PV',31,N'MWp',NULL,60.0,17800,NULL,N'Brochure text appears to contain a unit typo (''60 Wh''); model uses 60 GWh.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (17,N'WINNERGY',N'Winnergy Solar Power',3,N'Aswan',NULL,N'Operating',N'Solar PV',25,N'MWp',NULL,NULL,NULL,NULL,N'Co-shareholder Al Tawakol GILA; remote monitoring from Cape Town.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (18,N'CTT',N'Central Térmica de Temane',4,N'Temane',NULL,N'In Construction',N'Natural Gas',450,N'MW',NULL,NULL,1500000,NULL,N'Brochure expected first power in 2024; status is a brochure snapshot and must be verified.',1);
INSERT INTO dw.DimPlant (PlantKey,PlantCode,PlantName,GeographyKey,City,Province,ProjectStatus,PrimaryTechnologyName,NameplateCapacity,CapacityUnit,StorageCapacityMWh,BrochureAnnualGenerationGWh,BrochureHomesEquivalent,BrochureCO2AvoidedTonnes,SourceNotes,IsActive) VALUES (19,N'MENENGAI',N'Menengai Geothermal Plant',1,N'Nakuru County',NULL,N'In Construction',N'Geothermal',35,N'MW',NULL,NULL,NULL,NULL,N'Steam supplied by GDC; Toyota Tsusho is EPC contractor; brochure expected operations in 2025.',1);
GO
...
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (1,1,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
...
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (3,2,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
...
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (5,3,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
...
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (7,4,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
...
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (9,5,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (10,6,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
...
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (12,7,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
...
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (14,8,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
...
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (16,9,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (17,10,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (18,11,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
...
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (20,12,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
...
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (22,13,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
...
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (24,14,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
...
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (26,15,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
...
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (28,16,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
...
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (30,17,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
...
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (32,18,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
...
INSERT INTO dw.BridgePlantOrganisation (PlantOrganisationKey,PlantKey,OrganisationKey,RoleType,OwnershipPercent,Notes) VALUES (34,19,1,N'Developer / Owner / Operator',NULL,N'Brochure states Globeleq role at portfolio or plant level.');
