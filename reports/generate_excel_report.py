...
Produces: Globeleq_Energy_Intelligence_Report.xlsx
"""
import pandas as pd
import numpy as np
import openpyxl
...
# ── Colour palette (Globeleq brand: dark blue + amber + cyan) ──────────────
C_DARK_BLUE = "14443B"
C_AMBER     = "F7941D"
C_CYAN      = "00B4D8"
C_LIGHT_BG  = "EAF6F3"
...
t = ws0.cell(row=2, column=2, value="GLOBELEQ ENERGY INTELLIGENCE PLATFORM")
...
title = ws1.cell(row=1, column=1, value="PORTFOLIO ANNUAL KPIs — GLOBELEQ ENERGY INTELLIGENCE PLATFORM")
...
t7 = ws7.cell(row=1, column=1, value="MACHINE LEARNING MODEL REGISTRY — GLOBELEQ ENERGY INTELLIGENCE")
...
# ── Save ──────────────────────────────────────────────────────
out_path = os.path.join(OUT_DIR, "Globeleq_Energy_Intelligence_Report.xlsx")
wb.save(out_path)
